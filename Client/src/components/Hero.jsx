...
const Hero = () => {
    ...
    const onSearch = async (e) =>{
        ...
        await axios.post('/api/user/store-reacent-search',{recentSearchedCity: destination},{
          ...
          setSearchedCities((prevSearchedCities)=>{
            ...
            if(updatedSearchedCities.length >3){
                updatedSearchedCities.shift(); //remove oldest searched city
            }
  ...
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-32 text-white bg-[url("/src/assets/heroImage.png")] 
    bg-no-repeat bg-cover bg-center h-screen'>
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparalled luxuary and comfort await at the world's most exclusive hotels and resorts. Start your journey today.</p>

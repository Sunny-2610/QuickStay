    ...
    return (
        <div className="py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
            <Title
                ...
                align="left"
            />
            <div className='max-w-6xl mt-8 w-full text-gray-800'>{/* ✅ fixed '-full' to 'w-full' */}
                <div className='hidden md:grid md:grid-cols-[3fr_2fr_1fr] w-full border-b border-gray-300 font-medium text-base py-3'>
                    <div className='w-1/3'>Hotels</div>
                    <div className='w-1/3'>Date & Timings</div>
                    <div className='w-1/3'>Payment</div> {/* ✅ fixed typo "Paymnt" */}
                </div>
                    ...
                    >
                        ...
                        <div className='flex flex-col md:flex-row'>
                            <img
                                ...
                                alt="hotel-img"
                                className='w-44 h-32 rounded shadow object-cover md:ml-4' // ✅ fixed invalid Tailwind classes
                            />
                        ...
                        {/* Payment Status */}
                        <div className='flex flex-col items-start justify-cnter pt-3'>
